...
class Rental(db.Model):
    ...
    customer_id = db.Column(db.Integer, db.ForeignKey('customer.id', ondelete='cascade'), primary_key=True, nullable=True)
    video_id = db.Column(db.Integer, db.ForeignKey('video.id', ondelete='cascade'),primary_key=True, nullable=True)
